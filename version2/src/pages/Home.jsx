...
const Home = () => {
    return (
        <div className="grid w-full grid-cols-[1fr_2fr_1fr] items-center gap-10 overflow-y-auto">
            <div className="sticky top-0 h-full w-full overflow-y-auto p-3">
                {leftbarOptionsData.map((data) => (
                    <Link
                        to={Routes[data.path].path}
                        className="flex cursor-pointer items-center gap-2 rounded-lg px-3 py-2 hover:bg-slate-100"
                    >
                ...
                <div className="flex cursor-pointer items-center gap-2 rounded-lg px-3 py-2 hover:bg-slate-100">
