...
function HomePage_Rightbar() {
    return (
        <div className='homepage_Rightbar'>
            <div className="homepage_RightbarWidget_header">
                <div className="homepage_RightbarWidget_headerleft">
                    <h4>Your Pages</h4>
                </div>
                <MoreHorizIcon />
            </div>

            <div className="homepage_RightbarWidget_body">
                <div className="homepage_RightbarWidget_bodyOptions">
                ...
                <div className="homepage_RightbarWidget_bodyOptions ml-10">
            ...
            <div className="homepage_RightbarWidget_header">
                ...
                <div className="homepage_RightbarWidget_headerright">
                    <SearchIcon />
                    <MoreHorizIcon />
                </div>
            </div>
